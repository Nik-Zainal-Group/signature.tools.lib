...
test_that("test genomePlot() using subs/indels vcfs, comma-separated copy number and rearrangment bedpe input file formats and compare with the expected", {
...
output_png <- genomePlot("test.sub.vcf","test.indel.vcf.gz","test.cnvs.txt","test.bedpe","test")
