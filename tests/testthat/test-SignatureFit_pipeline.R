...
test_that("test that signatureFit_pipeline() works on double substitutions with default parameters. Common T2", {
...
test_that("test that signatureFit_pipeline() works on rearrangements with default parameters. Common T2", {
